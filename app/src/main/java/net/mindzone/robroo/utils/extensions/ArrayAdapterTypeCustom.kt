...
class ArrayAdapterTypeCustom(
    context: Context,
    private val textViewResourceId: Int,
    private var items: ArrayList<net.mindzone.robroo.data.manualDocument.entity.listDocumentType.ResponseData>
) : ArrayAdapter<net.mindzone.robroo.data.manualDocument.entity.listDocumentType.ResponseData>(context, textViewResourceId, items) {
    ...
    override fun getItem(position: Int): net.mindzone.robroo.data.manualDocument.entity.listDocumentType.ResponseData =
        if (position == 0)
            items[0]
