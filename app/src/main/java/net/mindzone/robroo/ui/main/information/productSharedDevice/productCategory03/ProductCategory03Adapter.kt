...
import net.mindzone.robroo.ui.main.information.productSharedDevice.productInfoDetail03.ProductInfoDetail03Fragment
import net.mindzone.robroo.utils.AuditType
import net.mindzone.sampleaudit.AuditManager

class ProductCategory03Adapter(private var list: List<ResponseData>,
                               private val context: Context) :
        RecyclerView.Adapter<ProductCategory03Adapter.MyViewHolder>() {
    ...
    private fun sendData ( title :String){
        val fragment = ProductInfoDetail03Fragment()
        val bundle = Bundle()
